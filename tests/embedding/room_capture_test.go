...
func TestExternalRoomRejectsMissingProviderTrace(t *testing.T) {
	...
	host := roomswire.NewService(roomswire.Dependencies{Clock: scheduler, Live: live, Replay: runtimeRoomReplayWire.NewService(), Evidence: roomevidencewire.NewService()})
