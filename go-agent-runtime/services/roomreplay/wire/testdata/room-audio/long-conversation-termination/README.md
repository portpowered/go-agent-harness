...
```sh
go run ./go-agent-runtime/services/roomreplay/wire/testdata/room-audio/generate.go \
  --shape long-conversation-termination \
  --output go-agent-runtime/services/roomreplay/wire/testdata/room-audio/long-conversation-termination
```
