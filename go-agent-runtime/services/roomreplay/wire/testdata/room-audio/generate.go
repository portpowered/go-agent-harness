...
func generateLongConversationTermination(output string) error {
	...
	manifest := map[string]any{
		...
		"provenance": map[string]any{
			...
			"regeneration_command": "go run ./go-agent-runtime/services/roomreplay/wire/testdata/room-audio/generate.go --shape long-conversation-termination --output go-agent-runtime/services/roomreplay/wire/testdata/room-audio/long-conversation-termination",
...
func generate(output string) error {
	...
	manifest := map[string]any{
		...
		"provenance": map[string]any{
			...
			"regeneration_command": "go run ./go-agent-runtime/services/roomreplay/wire/testdata/room-audio/generate.go --output go-agent-runtime/services/roomreplay/wire/testdata/room-audio/clean-turn-taking",
			"hashes":               "sha256 and byte sizes for every replay artifact are embedded in this manifest",
		},
		"tolerances": map[string]any{
...
func generateDeliberateOverlap(output string) error {
	...
	manifest := map[string]any{
		...
		"provenance": map[string]any{
			...
			"regeneration_command":               "go run ./go-agent-runtime/services/roomreplay/wire/testdata/room-audio/generate.go --shape deliberate-overlap --output go-agent-runtime/services/roomreplay/wire/testdata/room-audio/deliberate-overlap",
			"hashes":                             "sha256 and byte sizes for every replay artifact are embedded in this manifest",
		},
		"tolerances": map[string]any{
