...
```sh
go run ./go-agent-runtime/services/roomreplay/wire/testdata/room-audio/generate.go --shape deliberate-overlap --output go-agent-runtime/services/roomreplay/wire/testdata/room-audio/deliberate-overlap
```
