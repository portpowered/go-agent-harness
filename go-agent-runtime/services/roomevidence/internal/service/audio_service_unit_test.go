...
func testRoomReplayAnnotationParticipants() (map[string]AudioParticipant, map[string]string) {
	participants := map[string]AudioParticipant{}
	streamOwners := map[string]string{}
	for _, id := range []string{"a", "b"} {
		participant := AudioParticipant{ID: id}
...
func assertRoomReplayAnnotationEvents(t *testing.T, participants map[string]AudioParticipant, streamOwners map[string]string) {
	t.Helper()
...
func assertRoomReplayAnnotationHelpers(t *testing.T, participants map[string]AudioParticipant) {
	t.Helper()
