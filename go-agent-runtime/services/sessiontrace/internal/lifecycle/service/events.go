...
import (
	...
	sessiondiagnostics "github.com/portpowered/go-agent-harness/go-agent-runtime/services/sessiontrace/internal/lifecycle"
)
...
func (r *reducer) applyLocked(event sessiondiagnostics.Event) (sessiondiagnostics.Observation, time.Duration, bool, error) {
	...
	case sessiondiagnostics.EventToolCall,
		...
		sessiondiagnostics.EventToolResponseComplete,
...
func (r *reducer) applyToolLocked(event sessiondiagnostics.Event) (sessiondiagnostics.Observation, time.Duration, bool, error) {
	...
	case sessiondiagnostics.EventToolResponseComplete:
		return r.toolResponseCompleteLocked(event.CallID), 0, false, nil
