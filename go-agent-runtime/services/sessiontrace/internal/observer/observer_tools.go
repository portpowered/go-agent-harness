...
func (o *observerState) ensureToolStateLocked() {
...
// later result.
func (o *observerState) observeProviderToolCall(v *messages.ToolCallEndValue) {
	if o == nil || v == nil {
		return
	}
	o.observeProviderToolCallWithID(v.ToolCallID, v.Name)
}
func (o *observerState) observeProviderToolCallWithID(callID, name string) {
...
func (o *observerState) noteToolResultAccepted(callID string) {
...
func (o *observerState) noteToolContinuationRequested() {
	if o == nil {
		return
	}
...
// method as well.
func (o *observerState) noteToolContinuationRequestedFor(callID string) {
...
func (o *observerState) signalToolLifecycle() {
	if o == nil {
		return
	}
	o.toolStateMu.Lock()
...
func (o *observerState) observeBufferedProviderToolLifecycle(deltas []messages.StreamMessage) {
	...
	for _, msg := range deltas {
		...
		o.observeBufferedProviderToolEvent(msg)
	}
}

func (o *observerState) observeBufferedProviderToolEvent(msg messages.StreamMessage) {
...
func (o *observerState) noteToolResultRejected(callID string, outcome messages.SessionSendOutcome) {
...
func (o *observerState) hasUnresolvedToolCalls() bool {
	if o == nil {
		return false
	}
	o.toolStateMu.Lock()
...
func (o *observerState) lifecycleContinuationStates() []sd.ContinuationState {
	if o == nil {
		return nil
	}
...
func (o *observerState) continuationState(callID string) (sd.ContinuationState, bool) {
	callID = strings.TrimSpace(callID)
	if callID == "" {
...
func (o *observerState) continuationResultAccepted(callID string) bool {
...
func (o *observerState) pendingNonImageToolContinuationCallIDs() []string {
	if o == nil {
		return nil
	}
	states := o.lifecycleContinuationStates()
...
func (o *observerState) unresolvedToolCallIDs() []string {
	if o == nil {
		return nil
	}
	o.toolStateMu.Lock()
