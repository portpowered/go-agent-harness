...
func newSessionUnresolvedToolResultsError(ids []string, statuses map[string]messages.SessionSendStatus) *SessionUnresolvedToolResultsError {
	return NewUnresolvedToolResultsError(ids, statuses)
}
...
func withUnresolvedToolResults(err error, observer *observerState) error {
	if observer == nil {
		return err
	}
...
func withPendingToolContinuations(err error, observer *observerState) error {
	if observer == nil {
		return err
	}
...
func withPendingImageContinuations(err error, observer *observerState) error {
	if observer == nil {
		return err
	}
