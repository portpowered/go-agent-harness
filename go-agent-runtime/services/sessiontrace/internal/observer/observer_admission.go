...
func (o *observerState) resetResponseOutputLocked() {
...
// The lock is held by every caller.
func (o *observerState) beginResponseContentLocked() {
	if o.messageEndSeen {
...
func (o *observerState) responseHasAdmissibleOutput() bool {
	if o == nil {
		return false
	}
	o.toolStateMu.Lock()
...
func (o *observerState) setAssistantResponseDone(done bool) {
	if o == nil {
		return
	}
	o.toolStateMu.Lock()
...
func (o *observerState) lastMessageEndAdmitted() bool {
	if o == nil {
		return false
	}
	o.toolStateMu.Lock()
