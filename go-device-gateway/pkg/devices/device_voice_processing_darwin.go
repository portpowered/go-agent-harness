...
type voiceProcessingIO struct {
	...
	inputFormat  audio.DeviceFormat
	outputFormat audio.DeviceFormat
...
var (
	...
	_ audio.AudioSource            = (*voiceProcessingEndpoint)(nil)
	_ audio.AudioSink              = (*voiceProcessingEndpoint)(nil)
...
func (h *voiceProcessingEndpoint) PlaybackStats() audio.PlaybackQueueStats {
	h.engine.mu.Lock()
	defer h.engine.mu.Unlock()
	return h.engine.playback.Snapshot()
}

func (h *voiceProcessingEndpoint) SetPlaybackRenderObserver(observer audio.PlaybackRenderObserver) {
