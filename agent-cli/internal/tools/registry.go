...
// NewEmptyToolRegistry creates a registry with no tools registered.
// Callers can use it as an isolated destination for an explicit tool
// selection without inheriting the default tool set.
