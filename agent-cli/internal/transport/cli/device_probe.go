...
func (c *ProbeRunCommand) writeDeviceProbeSkip(cmd interface {
...
}, positional []string, availability serviceDevices.DeviceProbeAvailability) error {
	...
	summary := deviceProbeSkipSummary{
		Total: len(selections), Skipped: len(selections), Status: serviceDevices.DeviceProbeStatusSkip,
	}
