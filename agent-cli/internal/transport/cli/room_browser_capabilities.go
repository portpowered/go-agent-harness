...
func NewRoomParticipantBrowserCapabilitiesFactory(configDir string) rooms.BrowserCapabilitiesFactory {
	...
	return func(participant room.Participant) (rooms.BrowserCapabilities, error) {
		if participant.BrowserTools == nil {
			return rooms.BrowserCapabilities{}, errors.New("room browser capability requested for a participant without browserTools")
		}
		...
		if err != nil {
			return rooms.BrowserCapabilities{}, err
		}
