...
// max-duration stop. It preserves every independent lifecycle failure joined
// by the runtime; the terminal event and recording still carry the duration
// classification, and only the process exit value is translated.
