...
func (s *playbackOverflowSession) RTCMedia() servicetest.RTCMediaEndpoints {
	if s == nil {
...
func (m *playbackOverflowInboundMedia) ReadFrame(ctx context.Context) (audio.PCMFrame, error) {
	select {
	case <-ctx.Done():
...
var _ servicetest.RTCMediaSession = (*playbackOverflowSession)(nil)
var _ audio.InboundMedia = (*playbackOverflowInboundMedia)(nil)
