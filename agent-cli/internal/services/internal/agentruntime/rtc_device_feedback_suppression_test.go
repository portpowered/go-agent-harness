...
func TestLocalFeedbackGateDropsTest42ShortEchoTransient(t *testing.T) {
	...
	frameDuration := feedbackDeviceDurationAtRate(audio.FrameSize, audio.SampleRate)
...
func writeAssistantResponse(t *testing.T, gate *audio.PCM16FeedbackGate, frames [][]int16) {
	t.Helper()
...
func filterAssistantEcho(t *testing.T, gate *audio.PCM16FeedbackGate, frames [][]int16, submitted *[][]int16) {
	t.Helper()
	for frame := range frames {
