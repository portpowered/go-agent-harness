...
func TestSessionWireObservationSeparatesCompletedTransportOperations(t *testing.T) {
	...
	dialer := observeSessionWire(wireTraceDialer{wireTraceConn{failure: failure}}, newTestSessionRunOptions(SessionRunOptions{ModelCatalog: testModelCatalog(), Clock: source, RuntimeObserver: observer}))
