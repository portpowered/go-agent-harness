...
func TestRunRoom_HumanParticipantPlaybackOverflowNamesParticipant(t *testing.T) {
	registry, err := audio.NewVirtualRegistry(audio.VirtualBackendConfig{
		Devices: []audio.VirtualDeviceConfig{
			...
			{ID: "customer-mic", Name: "customer mic", Direction: audio.DirectionInput, LoopbackID: "customer-mic-drain"},
			{ID: "customer-mic-drain", Name: "customer mic drain", Direction: audio.DirectionOutput},
			...
			{ID: "customer-speaker", Name: "customer speaker", Direction: audio.DirectionOutput, LoopbackID: "customer-speaker-drain"},
			{ID: "customer-speaker-drain", Name: "customer speaker drain", Direction: audio.DirectionInput},
		},
	})
	if err != nil {
