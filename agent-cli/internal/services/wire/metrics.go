...
func NewMetricsCollector(audioService audioio.Service, clockSource clock.Source, factory internalruntime.SessionRuntimeFactory) serviceprobes.MetricsCollector {
	return internalruntime.NewMetricsCollector(audioService, clockSource, factory)
}
