...
func NewRoomService(live runtimeSession.LiveService, media runtimeRooms.MediaFactory, replay roomreplay.Service, registry devicegw.DeviceRegistry, clockSource clock.Scheduler, runtimeToolService runtimeTools.Service) runtimeRooms.Service {
	return roomwire.NewService(roomwire.Dependencies{Live: live, Media: media, Replay: replay, Registry: registry, Clock: clockSource, Tools: runtimeToolService})
}
...
func NewRoomServiceWithDevices(live runtimeSession.LiveService, deviceService runtimeDevices.Service, replay roomreplay.Service, registry devicegw.DeviceRegistry, clockSource clock.Scheduler, runtimeToolService runtimeTools.Service) runtimeRooms.Service {
	return roomwire.NewService(roomwire.Dependencies{Live: live, Devices: deviceService, Replay: replay, Registry: registry, Clock: clockSource, Tools: runtimeToolService})
}
