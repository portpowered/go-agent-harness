...
func newSessionSignalContext(parent context.Context) (context.Context, func(), *services.SessionCancellationIntent) {
	if parent == nil {
	...
	intent := services.NewSessionCancellationIntent()
