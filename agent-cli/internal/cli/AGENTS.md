...
- **OS**: darwin
- **Architecture**: arm64
- **Workspace**: `/Users/abdifamily/work/harness/go-agent-harness/.claude/worktrees/audio-input-rate-24k/agent-cli/internal/cli`
...
Configuration is loaded from `/Users/abdifamily/work/harness/go-agent-harness/.claude/worktrees/audio-input-rate-24k/agent-cli/internal/cli/config.yaml`.
...
```
/Users/abdifamily/work/harness/go-agent-harness/.claude/worktrees/audio-input-rate-24k/agent-cli/internal/cli/
