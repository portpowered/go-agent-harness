...
func TestParse_ExtractsSortedPackageAndTestTimings(t *testing.T) {
	input := strings.NewReader(strings.Join([]string{
		`{"Action":"run","Package":"github.com/portpowered/go-agent-harness/agent-cli/internal/tools","Test":"TestFast"}`,
		`{"Action":"pass","Package":"github.com/portpowered/go-agent-harness/agent-cli/internal/tools","Test":"TestFast","Elapsed":0.01}`,
		`{"Action":"pass","Package":"github.com/portpowered/go-agent-harness/agent-cli/test/integration","Test":"TestSessionReplay","Elapsed":1.25}`,
		`{"Action":"pass","Package":"github.com/portpowered/go-agent-harness/agent-cli/internal/tools","Elapsed":0.02}`,
		`not-json`,
		`{"Action":"pass","Package":"github.com/portpowered/go-agent-harness/agent-cli/test/integration","Elapsed":1.30}`,
	}, "\n"))
	...
	if summary.Packages[0].Package != "github.com/portpowered/go-agent-harness/agent-cli/test/integration" {
...
func TestWriteReport_DistinguishesPreflightFromSuiteTiming(t *testing.T) {
	summary := Summary{
		Packages: []Entry{{
			Package:  "github.com/portpowered/go-agent-harness/agent-cli/test/integration",
			Action:   "pass",
