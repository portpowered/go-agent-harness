...
func (s *fixtureSession) emitContinuation(turn int) {
	...
	s.queue(context.Background(),
		...
		messages.StreamMessage{Type: messages.StreamTypeAudioDelta, Role: messages.RoleAssistant, ResponseID: responseID, Value: messages.NewAudioDeltaValueWithMediaType(pcm[:0], "audio/pcm;rate=16000")},
