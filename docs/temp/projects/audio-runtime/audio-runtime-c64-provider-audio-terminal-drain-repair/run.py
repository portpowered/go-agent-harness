...
TERMINAL_DRAIN_TEST_RELATIVE = Path("agent-cli/internal/services/internal/agentruntime/rtc_device_runtime_terminal_drain_test.go")
TEST_FIXTURE_RELATIVES = (TEST_RELATIVE, TERMINAL_DRAIN_TEST_RELATIVE)
