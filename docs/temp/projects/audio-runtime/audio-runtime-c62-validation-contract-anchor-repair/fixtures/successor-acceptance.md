...
compatibility symbols are explicit `Deprecated:` aliases or thin adapters with
no independent decisions or mutable state. CLI packages own only presentation,
