...
The diff against `origin/main` contains only the two admitted Go paths plus this owned evidence directory. C154 is a baseline causal slice, not C143 recovery or vertical/project acceptance. The exact pushed head is ready for script-owned CI; this PR body does not claim CI green, independent review, guarded merge or later-gate completion.
