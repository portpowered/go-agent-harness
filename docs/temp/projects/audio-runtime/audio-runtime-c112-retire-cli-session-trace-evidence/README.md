...
checkpoint is `dee72ae047db826a049c41fe5be2410d09135c6e`; the deterministic
public-boundary probe checkpoint is
`4d1264c682c046ea69a95075efb3941bd496101c`; and the shipped-YUI loopback
evidence-runner checkpoint is
`3378b7183c8801b7c6a43552bfd069b080971d1a`; the current integrated head is
`b7c8fad39ea82d473d8207be4b59a37116063e28`. These checkpoints follow final
candidate merge `cea43e874a6d2d2eded0ab0f5b19e48dcfd3b983` and the later fetched-main
integration on branch
...
- Current fetched `origin/main`: `915ed982d23f2e549e529ff43c4f370b4b51e394`; it is an ancestor of the integrated head.
- Required startup ancestor: `8bdafc7f947a3a2c9856220abdc539437035bd21`.
- The C116 current-main integration was merge commit `708013bd419175482fd5aad5d1e83432e8d71b33`; mainline `bd6a1289` was integrated by final candidate merge `cea43e87`, and fetched mainline `915ed982` was then integrated by head `b7c8fad`, preserving the predecessor and C79 ancestry. Checkpoint `dee72ae` adds the service-owned atomic no-replace publication repair; checkpoint `4d1264c` adds the public sessiontrace boundary probe, and the shipped artifact was rebuilt from integrated head `b7c8fad`.
...
python3 .../run.py --case trace-audio-tool-replay --case interruption-replay --child-timeout 60 --aggregate-timeout 240
```
...
Final runner result from a yui artifact rebuilt at integrated head
`b7c8fad39ea82d473d8207be4b59a37116063e28` using `make -C agent-cli build`
...
`c9a3bea25d468a652bade1847e9d5db14595649a0e2905492da81c81af74e34c`, and run
directory `runs/vertical-20260913T160858Z-95268`:

- Tool replay: exit 0, no timeout/survivors, 29 timeline events/21 runtime events, provider PCM 4,800 bytes (`0e769b4aa4a4532ee188a966ec485fb98d0938bcb77bceac7a85edce15b92502`), rendered PCM 4,800 bytes (`0e769b4aa4a4532ee188a966ec485fb98d0938bcb77bceac7a85edce15b92502`), speaker trace 4,844 bytes (`305d40c0fa1b687133be6a7841654dcbe89310b7b7f9800cb624c25bcffd880c`), deterministic microphone input 1,440 bytes (`db9ac5111b2173f5f0e7909539a7dea70134b5736d4f2582c99e25705aab6148`), derived fixture (`62835dcb8270ab1dba865d078e79b13a3c6c3c89454c65f5eb7f5bb42586a714`), shipped microphone-uploaded and speaker-enqueued taps, provider-wire upload hash (`62577fa1704906f645e83ad99676080d7312a356b21262e6e95a9d192052482a`), nine correlated simulated capture/render callbacks, all four C112 audio boundaries, and `PROBE_TOOL_MARKER_9182` plus `strict replay continuation`.
...
## Fresh local gate checkpoint — 2026-09-13T16:08:58Z

On integrated evidence-runner head `b7c8fad39ea82d473d8207be4b59a37116063e28`, with
final candidate merge `cea43e874a6d2d2eded0ab0f5b19e48dcfd3b983` and
the required fetched `origin/main` `915ed982d23f2e549e529ff43c4f370b4b51e394`, the owned
...
`make architecture-size-check` pass at 199 packages, 1,932 files, and 28,704
...
`runs/vertical-20260913T160858Z-95268`; its shipped tool replay records the
upload/enqueue edges and nine correlated simulated capture/render callbacks,
while its separate public-service probes pass all four service taps and
provider send/receive/terminal redaction for both replay cases.
...
are complete at `dee72ae`, with the public-service boundary probe at `4d1264c`
and the refreshed shipped loopback artifact/run bound to `3378b71`. Focused causal tests, accumulated replay regressions,
...
C112 defect was implicated. Changed head `b7c8fad39ea82d473d8207be4b59a37116063e28`
