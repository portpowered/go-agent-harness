...
Repair the current-main live terminal-drain race by claiming provider RTC media immediately after `ConnectSession()` and before `Receive()`. The existing continuous-audio option is preserved and the later media attachment remains idempotent. Source checkpoint: `53bf5739f47412d33e2a8cd7165287f55839a752`; the candidate also contains freshly fetched `origin/main` `bd6a1289218d1bef1a3af36e64e9d4496062416f`.
