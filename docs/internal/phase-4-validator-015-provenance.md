...
`P4-GATE-01` remains open in this lane.
...
| `P4-API-04` | `docs/internal/phase-4-api-contract-validator.md`; `docs/architecture/contract-gap-audit.md#p4-api-04-provider-capability-discovery-and-unsupported-feature-validation` | Superseded by current capability evidence, including supported, unsupported, and unknown states; provider coverage remains incomplete. |
...
| `P4-API-06` | `docs/internal/phase-4-api-contract-validator.md`; `docs/architecture/contract-gap-audit.md#p4-api-06-context-cancellation-timeout-and-retry-semantics` | Superseded by current context, cancellation, timeout, retry, and validation evidence; repair work remains open. |
...
| `P4-GATE-01` | `docs/internal/phase-4-api-contract-validator.md`; `docs/architecture/contract-gap-audit.md#p4-gate-01-phase-4-closure-gate` | Superseded by the current final-gate decision; explicitly remains open. |
